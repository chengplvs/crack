from models.buildDropout import create_modelA, create_modelB, create_modelC
from tensorflow.keras.applications import ResNet101

def create_resnet101(optimizer,
...
def create_resnet101B(optimizer,
                      loss='binary_crossentropy',
                      metrics=['accuracy']):
    # 建立卷積基底
    base_model = ResNet101(include_top=False,
...
def create_resnet101C(optimizer,
                      loss='binary_crossentropy',
                      metrics=['accuracy']):
    base_model = ResNet101(include_top=False,
                           weights='imagenet',
